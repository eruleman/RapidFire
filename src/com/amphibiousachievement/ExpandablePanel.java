...
/**
 * An expandable panel (custom layout) in Android which is capable of handling
 * all the expand and collapse animations exactly similar to Google Play app
 * "description" action.
 * 
 * Source: http://krishnalalstha.wordpress.com/2013/02/19/android-expandable-layout/
 * 
 */
...
//    private View mContent2;
    ...
    public ExpandablePanel(Context context, AttributeSet attrs) {
        ...
        mAnimationDuration = a.getInteger(
                    R.styleable.ExpandablePanel_animationDuration, 200);
...
//        int content2Id = a.getResourceId(
//                R.styleable.ExpandablePanel_content2, 0);
//		if (content2Id == 0) {
//		    throw new IllegalArgumentException(
//		                "The content2 attribute is required and must " +
//		                "refer to a valid child.");
//		}
...
//        mContent2 = findViewById(mContent2Id);
//        if (mContent == null) {
//            throw new IllegalArgumentException(
//                "The content2 attribute must refer to an"
//                    + " existing child.");
//        }
        ...
        // ERIC: Added the following lines to make the colorBar start off in the collapsed state:
//		lp = mContent2.getLayoutParams();
//		lp.height = mCollapsedHeight;
//		mContent2.setLayoutParams(lp);
//        System.out.println("Here1");
//        TextView colorBar = (TextView) findViewById(R.id.Question1_ColorBar);
//        System.out.println("Here2");
//        if (colorBar != null) System.out.println("colorBar is not null");
//		lp = colorBar.getLayoutParams();
//        System.out.println("Here3");
//		lp.height = mCollapsedHeight;
//        System.out.println("Here4");
//		colorBar.setLayoutParams(lp);
//        System.out.println("Here5");
	 ...
	 * 
	 * NOTE ERIC: That last sentence may cause you trouble! Change this method
	 * if necessary.
	 */
    @Override
...
//        }
    ...
    private class ExpandAnimation extends Animation {
        ...
        protected void applyTransformation(float interpolatedTime, 
            ...
            LinearLayout question1 = (LinearLayout) findViewById(R.id.Question1);
            
            
//			lp = question1.getLayoutParams();
//			lp.height = (int) (mStartHeight + mDeltaHeight * interpolatedTime);
//            
//			question1.setLayoutParams(lp);
            
            // ERIC added these following lines
//            TextView colorBar = (TextView) findViewById(R.id.Question1_ColorBar);
//			lp = colorBar.getLayoutParams();
//			lp.height = (int) (mStartHeight + mDeltaHeight * interpolatedTime);
//            
